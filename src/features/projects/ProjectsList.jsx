      ...
      {projects.map((project, i) => (
        ...
        >
          <div className="relative w-full">
            ...
            >
              <div className="cursor-pointer rounded-full bg-white p-2 opacity-90 shadow-sm">
          ...
          <div className="-z-70 p-4">
            <div className="mb-2 flex items-start justify-between">
              <h3 className="cursor-pointer text-lg font-semibold text-gray-800 hover:text-indigo-600">
                {project.title}
              </h3>
              <div

...
const StatusDropdown = () => {
  return (
    <div className="absolute left-0 z-50 mt-2 w-48 rounded-lg bg-white shadow-lg dark:bg-gray-800 dark:text-white">
      <div className="py-1">
        ...
        <div className="flex cursor-pointer items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700">
          <FaClock className="mr-2 text-gray-500 dark:text-gray-400" /> In
          Progress
        </div>
        <div className="flex cursor-pointer items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700">

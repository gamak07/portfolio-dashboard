...
import { useFormValidation } from "../../../hooks/blog/useFormValidation";
import { useEditBlog } from "../../../hooks/blog/useEditBlog";
import { useTextEditor } from "../../../hooks/useTextEditor";
import { EditorContent } from "@tiptap/react";
import { useForm } from "react-hook-form";

const NewBlogForm = ({ initialData }: { initialData: any }) => {
  const isEdit = Boolean(initialData && initialData.id);
  const {
    isCreating: createIsCreating, // <-- Renamed
  ...
  // FIX: Aliases were swapped. useEditBlog returns 'isEditing'
  const {
    isEditing: editIsEditing, // <-- Renamed
  ...
  // FIX: Use the new alias names
  const isLoading = isEdit ? editIsEditing : createIsCreating;

...
const MessageDetails = ({ setShowDetails }: { setShowDetails: () => void }) => {
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute top-0 right-0 h-full w-full max-w-2xl overflow-y-auto bg-white shadow-xl dark:bg-gray-800">
        ...
        <div className="flex shrink-0 justify-between border-t border-gray-200 px-4 py-4 dark:border-gray-600">
          <div className="flex">
